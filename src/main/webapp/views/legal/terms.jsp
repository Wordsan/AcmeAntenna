...
<div>
	...
	<div>
        ...
        <p><spring:message code="legal.terms.block8.text1" /></p>
        <ul>
            <li><spring:message code="legal.terms.block8.text2" /></li>
            <li><spring:message code="legal.terms.block8.text3" /></li>
            <li><spring:message code="legal.terms.block8.text4" /></li>
            <li><spring:message code="legal.terms.block8.text5" /></li>
        </ul>
    </div>
