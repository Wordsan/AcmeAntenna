...
{
    List<PlatformSubscription> findAllByUserAndPlatformOrderByStartDateDesc(User user, Platform platform);
    ...
    List<PlatformSubscription> findAllByUserOrderByStartDateDesc(User user);
}